Public Class frmAltaProductoDesdeVenta
    ...
    Public Sub New(lista As List(Of DetalleVenta), listaSinCodigo As List(Of DetalleVentaSinCodigo), codigoNuevo As String, idCondicionDeVenta As Integer, idCliente As Integer)
    ...
    Private Sub frmAltaProductoDesdeVenta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If codigoNuevo <> "" Then
        ...
        If Validar() Then
            If MsgBox("¿ESTA SEGURO?", vbYesNo + vbQuestion) = vbYes Then
                ...
                Else
                    ...
                    funcion.AbrirFormEnPanel(New frmVentas(detalle, detalleSinCodigo, producto, idCondicionDeVenta, idCliente))
                End If
            End If
        End If
    End Sub
    ...
    Private Sub btnCancelar_Click(sender As Object, e As EventArgs) Handles btnCancelar.Click
        funcion.AbrirFormEnPanel(New frmVentas(detalle, detalleSinCodigo, idCondicionDeVenta, idCliente))
