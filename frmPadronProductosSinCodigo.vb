Public Class frmPadronProductosSinCodigo
    Dim detalle As New List(Of DetalleVenta)
    Dim detalleSinCodigo As New List(Of DetalleVentaSinCodigo)
    Dim ds = New DataSet
    Dim productos As New Funciones()
    Dim idCondicionDeVenta As Integer
    Dim idCliente As Integer

    Public Sub New(ByVal lista As List(Of DetalleVenta), ByVal listaSinCodigo As List(Of DetalleVentaSinCodigo), idCondicionDeVenta As Integer, idCliente As Integer)
    ...
    Private Sub btnAltaProducto_Click(sender As Object, e As EventArgs) Handles btnAltaProducto.Click
        ...
        mostrarPanel.AbrirFormEnPanel(New frmAltaProductoDesdeVenta(detalle, detalleSinCodigo, "", idCondicionDeVenta, idCliente))

    End Sub

    Private Sub frmPadronProductosSinCodigo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub dgvProductos_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvProductos.CellDoubleClick
        ...
        abreForm.AbrirFormEnPanel(New frmVentas(detalle, detalleSinCodigo, producto, idCondicionDeVenta, idCliente))
    End Sub
End Class